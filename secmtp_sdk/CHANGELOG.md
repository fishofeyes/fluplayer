...
## 1.0.15
    * Added and aligned core APIs for compliance, waterfall filter, revenue listener, show config, and related SDK capabilities.

## 1.0.14
    * Changed license to MIT.

## 1.0.13
    * Splash ads support bottom brand view 
    * Fixed Android multi-FlutterEngine channel conflicts.
