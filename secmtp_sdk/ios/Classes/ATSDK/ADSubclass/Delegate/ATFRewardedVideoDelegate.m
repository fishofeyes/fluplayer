...
- (void)didStartLoadingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra {
    ATFLog(@"ADSource--AD--Start--ATFRewardedVideoDelegate::didStartLoadingADSourceWithPlacementID:%@---extra:%@", placementID,extra);
    
    NSMutableDictionary *dic = [ATFDisposeDataTool revampSucceedCallDic:RewardedVideoDidAdSourceAttempt placementID:placementID extraDic:extra];
    [SendEventManger sendMethod: RewardedVideoCallName arguments:dic result:nil];
}

- (void)didFinishLoadingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra {
    ATFLog(@"ADSource--AD--Finish--ATFRewardedVideoDelegate::didFinishLoadingADSourceWithPlacementID:%@---extra:%@", placementID,extra);
    NSMutableDictionary *dic = [ATFDisposeDataTool revampSucceedCallDic:RewardedVideoDidAdSourceLoadFilled placementID:placementID extraDic:extra];
    [SendEventManger sendMethod: RewardedVideoCallName arguments:dic result:nil];
}

- (void)didFailToLoadADSourceWithPlacementID:(NSString*)placementID extra:(NSDictionary*)extra error:(NSError*)error {
    ATFLog(@"ADSource--AD--Fail--ATFRewardedVideoDelegate::didFailToLoadADSourceWithPlacementID:%@---error:%@", placementID,error);
    NSMutableDictionary *dic = [ATFDisposeDataTool revampFailCallDic:RewardedVideoDidAdSourceLoadFail placementID:placementID extraDic:extra error:error];
    [SendEventManger sendMethod: RewardedVideoCallName arguments:dic result:nil];
}

#pragma mark - 广告源 级别回调 - 竞价
- (void)didStartBiddingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra {
    ATFLog(@"ADSource--bid--Start--ATFRewardedVideoDelegate::didStartBiddingADSourceWithPlacementID:%@---extra:%@", placementID,extra);
    NSMutableDictionary *dic = [ATFDisposeDataTool revampSucceedCallDic:RewardedVideoDidAdSourceBiddingAttempt placementID:placementID extraDic:extra];
    [SendEventManger sendMethod: RewardedVideoCallName arguments:dic result:nil];
}

- (void)didFinishBiddingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra {
    ATFLog(@"ADSource--bid--Finish--ATFRewardedVideoDelegate::didFinishBiddingADSourceWithPlacementID:%@--extra:%@", placementID,extra);
    NSMutableDictionary *dic = [ATFDisposeDataTool revampSucceedCallDic:RewardedVideoDidAdSourceBiddingFilled placementID:placementID extraDic:extra];
    [SendEventManger sendMethod: RewardedVideoCallName arguments:dic result:nil];
}

- (void)didFailBiddingADSourceWithPlacementID:(NSString*)placementID extra:(NSDictionary*)extra error:(NSError*)error {
    ATFLog(@"ADSource--bid--Fail--ATFRewardedVideoDelegate::didFailBiddingADSourceWithPlacementID:%@--extra:%@--error:%@", placementID, extra, error);
    NSMutableDictionary *dic = [ATFDisposeDataTool revampFailCallDic:RewardedVideoDidAdSourceBiddingFail placementID:placementID extraDic:extra error:error];
    [SendEventManger sendMethod: RewardedVideoCallName arguments:dic result:nil];
}
...
- (void)didFinishMultipleLoadingADWithPlacementID:(NSString *)placementID
    ...
    NSMutableDictionary *dic = [ATFDisposeDataTool revampSucceedCallDic:RewardedVideoDidMultipleLoaded placementID:placementID extraDic:requestingInfoDic];
    [SendEventManger sendMethod: RewardedVideoCallName arguments:dic result:nil];
}
...
- (void)rewardedVideoDidFailToPlayForPlacementID:(NSString *)placementID error:(NSError *)error extra:(NSDictionary *)extra {
    ...
    [SendEventManger sendMethod: RewardedVideoCallName arguments:dic result:nil];
    ATFLog(@"Rewarded video ad failed to play,reason:%@",error);
}
...
- (void)rewardedVideoAgainDidFailToPlayForPlacementID:(NSString *)placementID error:(NSError *)error extra:(NSDictionary *)extra {
    ...
    [SendEventManger sendMethod: RewardedVideoCallName arguments:dic result:nil];
    ATFLog(@"Rewarded video again ad failed to play,reason:%@",error);
}
