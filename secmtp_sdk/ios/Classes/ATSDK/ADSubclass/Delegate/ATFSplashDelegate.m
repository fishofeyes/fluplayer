...
- (void)didStartLoadingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra {
    ...
    NSMutableDictionary *dic = [ATFDisposeDataTool revampSucceedCallDic:SplashDidAdSourceAttempt placementID:placementID extraDic:extra];
...
- (void)didFinishLoadingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra {
    ...
    NSMutableDictionary *dic = [ATFDisposeDataTool revampSucceedCallDic:SplashDidAdSourceLoadFilled placementID:placementID extraDic:extra];
    [SendEventManger sendMethod: SplashAdCallName arguments:dic result:nil];
}
...
- (void)didFailToLoadADSourceWithPlacementID:(NSString*)placementID extra:(NSDictionary*)extra error:(NSError*)error {
    ...
    NSMutableDictionary *dic = [ATFDisposeDataTool revampFailCallDic:SplashDidAdSourceLoadFail placementID:placementID extraDic:extra error:error];
    [SendEventManger sendMethod: SplashAdCallName arguments:dic result:nil];
}
...
- (void)didStartBiddingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra {
    ...
    NSMutableDictionary *dic = [ATFDisposeDataTool revampSucceedCallDic:SplashDidAdSourceBiddingAttempt placementID:placementID extraDic:extra];
    [SendEventManger sendMethod: SplashAdCallName arguments:dic result:nil];
}
...
- (void)didFinishBiddingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra {
    ...
    NSMutableDictionary *dic = [ATFDisposeDataTool revampSucceedCallDic:SplashDidAdSourceBiddingFilled placementID:placementID extraDic:extra];
    [SendEventManger sendMethod: SplashAdCallName arguments:dic result:nil];
}
...
- (void)didFailBiddingADSourceWithPlacementID:(NSString*)placementID extra:(NSDictionary*)extra error:(NSError*)error {
    ...
    NSMutableDictionary *dic = [ATFDisposeDataTool revampFailCallDic:SplashDidAdSourceBiddingFail placementID:placementID extraDic:extra error:error];
    [SendEventManger sendMethod: SplashAdCallName arguments:dic result:nil];
}
...
- (void)didFinishMultipleLoadingADWithPlacementID:(NSString *)placementID
    ...
    NSMutableDictionary *dic = [ATFDisposeDataTool revampSucceedCallDic:SplashDidMultipleLoaded placementID:placementID extraDic:requestingInfoDic];
    [SendEventManger sendMethod: SplashAdCallName arguments:dic result:nil];
}
...
- (void)didFailToLoadADWithPlacementID:(NSString*)placementID
                                 error:(NSError*)error {
    if (self.splashBottomDidHideBlock != nil) {
        self.splashBottomDidHideBlock();
    }
...
- (void)splashDidShowForPlacementID:(NSString *)placementID
    ...
    if (self.splashBottomDidShowBlock != nil) {
        self.splashBottomDidShowBlock();
    }
