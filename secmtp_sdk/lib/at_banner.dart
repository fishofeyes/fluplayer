...
/* Load banner ad */
  ...
  Future<String> showBannerInRectangle({
    ...
    final Map<String, Object?> dic = Map<String, Object?>.from(extraMap);
    if (atCustomContentResult != null) {
      dic['atCustomContentResult'] = atCustomContentResult;
    }
  ...
  Future<bool> entryBannerScenario({
    required String placementID,
    required String sceneID,
  }) async {
    return await AnythinkSdk.channel.invokeMethod("entryBannerScenario", {
      "placementID": placementID,
      "sceneID": sceneID,
    });
  }
