...
enum InterstitialStatus {
  ...
  interstitialAdDidMultipleLoaded,

  interstitialAdDidAdSourceBiddingAttempt,
...
class ATInterstitialResponse extends BaseResponse{
  ...
  factory ATInterstitialResponse.withMap(Map map){
    ...
    else if(adStatus == 'interstitialAdDidMultipleLoaded'){
      temprewardstatus = InterstitialStatus.interstitialAdDidMultipleLoaded;
    }
    else if(adStatus == 'interstitialAdDidAdSourceBiddingAttempt'){
      temprewardstatus = InterstitialStatus.interstitialAdDidAdSourceBiddingAttempt;
    }
    else if(adStatus == 'interstitialAdDidAdSourceBiddingFilled'){
      temprewardstatus = InterstitialStatus.interstitialAdDidAdSourceBiddingFilled;
    }
    else if(adStatus == 'interstitialAdDidAdSourceBiddingFail'){
      temprewardstatus = InterstitialStatus.interstitialAdDidAdSourceBiddingFail;
    }
    else if(adStatus == 'interstitialAdDidAdSourceAttempt'){
      temprewardstatus = InterstitialStatus.interstitialAdDidAdSourceAttempt;
    }
    else if(adStatus == 'interstitialAdDidAdSourceLoadFilled'){
      temprewardstatus = InterstitialStatus.interstitialAdDidAdSourceLoadFilled;
    }
    else if(adStatus == 'interstitialAdDidAdSourceLoadFail'){
      temprewardstatus = InterstitialStatus.interstitialAdDidAdSourceLoadFail;
    }
