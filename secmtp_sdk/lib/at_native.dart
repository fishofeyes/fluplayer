...
enum ATCustomViewNative { image, label, view }
...
class ATNative {
  ...
  Future<bool> nativeAdReady({required String placementID}) async {
  ...
  /*Check ad status */
  Future<Map> checkNativeAdLoadStatus({required String placementID}) async {
  ...
  Future<String> getNativeValidAds({required String placementID}) async {
  ...
  Future<bool> removeNativeAd({required String placementID}) async {
