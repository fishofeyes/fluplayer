...
enum RewardedStatus {
  ...
  rewardedVideoDidAdSourceBiddingAttempt,
...
class ATRewardResponse extends BaseResponse {
  ...
  factory ATRewardResponse.withMap(Map map){
    ...
    else if(adStatus == 'rewardedVideoDidMultipleLoaded'){
      tempRewardStatus = RewardedStatus.rewardedVideoDidMultipleLoaded;
    }
    else if(adStatus == 'rewardedVideoDidAdSourceBiddingAttempt'){
      tempRewardStatus = RewardedStatus.rewardedVideoDidAdSourceBiddingAttempt;
    }
    else if(adStatus == 'rewardedVideoDidAdSourceBiddingFilled'){
      tempRewardStatus = RewardedStatus.rewardedVideoDidAdSourceBiddingFilled;
    }
    else if(adStatus == 'rewardedVideoDidAdSourceBiddingFail'){
      tempRewardStatus = RewardedStatus.rewardedVideoDidAdSourceBiddingFail;
    }
    else if(adStatus == 'rewardedVideoDidAdSourceAttempt'){
      tempRewardStatus = RewardedStatus.rewardedVideoDidAdSourceAttempt;
    }
    else if(adStatus == 'rewardedVideoDidAdSourceLoadFilled'){
      tempRewardStatus = RewardedStatus.rewardedVideoDidAdSourceLoadFilled;
    }
    else if(adStatus == 'rewardedVideoDidAdSourceLoadFail'){
      tempRewardStatus = RewardedStatus.rewardedVideoDidAdSourceLoadFail;
    }
